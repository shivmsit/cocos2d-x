...
function(cocos2dx_resolve_root out_var)
    set(COCOS2DX_ROOT_PATH "" CACHE PATH
        "Path to the cocos2d-x source checkout that owns the reusable prebuilts")

    # An explicit CMake cache value always wins and should fail clearly when it
    # is stale instead of silently selecting a different engine checkout.
    ...
    elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/cocos2d")
        ...
        # This supports the common layout:
        #   workspace/cocos2d-x-<version>
        #   workspace/games/MyGame
