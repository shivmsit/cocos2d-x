...
function(cocos2dx_resolve_root out_var)
    ...
    elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/frameworks/cocos2d-x")
        _cocos2dx_validate_root(
            "${CMAKE_CURRENT_SOURCE_DIR}/frameworks/cocos2d-x" resolved_root)
        if(NOT resolved_root)
            message(FATAL_ERROR
                "${CMAKE_CURRENT_SOURCE_DIR}/frameworks/cocos2d-x exists but is "
                "not a compatible Cocos2d-x checkout")
        endif()
    else()
        ...
        elseif(valid_root_count GREATER 1)
            ...
            message(FATAL_ERROR
                ...
                "-DCOCOS2DX_ROOT_PATH=/path/to/cocos2d-x, or create the optional "
                "frameworks/cocos2d-x link.")
        endif()
    endif()
